...
Write a function named countNumberOfChildren that, given the array of characters, below, uses reduce to return the total number of children
in the data set.
------------------------------------------------------------------------------------------------ */
...
const countNumberOfChildren = (arr) => arr.reduce((accumulator, count) => count.children ? accumulator += count.children.length : accumulator += 0, 0);
// Solution code here...
...
const calculateAverage = (arr) => {
  // Solution code here...
  const reducer = arr.reduce((accumulator, value) => {
    accumulator.count++;
    accumulator.sum += value;
    return accumulator;
  }, { count: 0, sum: 0 });

  const average = reducer.sum / reducer.count;
...
const countPrimeNumbers = (arr) => {
  const reduced = arr.reduce((accumulator, currentValue) => {
    isPrime(currentValue) && accumulator++;
    return accumulator;
  }, 0);
