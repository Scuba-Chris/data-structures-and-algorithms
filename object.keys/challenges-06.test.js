...
const getCourseKeys = (obj) => {
  ...
  let theAwnsers = Object.keys(obj);
  return theAwnsers;
};
...
Write a function named hasChildrenEntries that is similar to your hasChildrenValues function from challenge 3, but uses the data's entries
